...
class ArticleReportContract extends Model<ArticleReportContractAttributes, ArticleReportContractCreationAttributes> implements ArticleReportContractAttributes {
  public id!: number;
